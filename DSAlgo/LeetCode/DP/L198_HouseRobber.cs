...
namespace DSAlgo.LeetCode.DP
{
    ...
    {
        // This is a dynamic programming problem where we want to maximize the amount of money we can rob from houses arranged in a line, given that we cannot rob two adjacent houses.
        // The idea is to use a bottom-up approach to build up the solution iteratively.
        // We maintain two variables, prev1 and prev2, which represent the maximum amount of money we can rob up to the previous house and the house before that, respectively.
        ...
        public int Rob(int[] nums)
        {
            ...
            int prev1 = 0; // Maximum amount we can rob up to the previous house
            int prev2 = 0; // Maximum amount we can rob up to the house before the previous one
        ...
        // This is a recursive approach with memoization to solve the same problem.
        ...
        // This is a recursive approach without memoization to solve the same problem.
        // The function takes an array of house values and an index representing the current house.
        ...
        // This is a tabulation approach to solve the same problem.
        // The function takes an array of house values and calculates the maximum amount we can rob using a bottom-up approach.
