...
namespace DSAlgo.LeetCode.DP
{
    public class L70_ClimbingStairs
    {
        ...
        // This method calculates the number of distinct ways to climb to the nth step using a bottom-up dynamic programming approach.
        ...
        // It recursively calculates the number of ways to reach the nth step by summing the ways to reach the last two steps.
        ...
        // Time Complexity: O(n)
        // Space Complexity: O(n)
        // This method calculates the number of distinct ways to climb to the nth step using a bottom-up tabulation approach.
